...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = [
        'name', 'identifier', 'type', 'verified_at', 'password', 'must_change', 'remember_token', 'profile_photo_path', 'is_active', 'last_login_at', 'settings', 'google_id', 'created_at', 'updated_at',
    ];
    ...
    /**
     * Get settings as array, handling cases where it might be stored as string
     */
    ...
    /**
     * Set settings ensuring it's properly stored as array
     */
